const quotes = [
  ...
  {
    quote:
      "If you cannot fly then run. If you cannot run, then walk. And, if you cannot walk, the crawl, but whatever you do, you have to keep moving forward.",
    author: "Martin Luther King Jr.",
  },
  {
    quote:
      "Our greatest weakness lies in giving up. The most certain wy to succeed is always to try just one more time",
